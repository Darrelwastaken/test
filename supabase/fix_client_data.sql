-- Fix Client Data - Run this in Supabase SQL Editor
-- This script creates the new table structure and populates it with data
...
-- 5. Clear existing data (if any) and insert sample data for existing clients
DELETE FROM manual_financial_inputs WHERE client_nric IN ('850102-14-5678', '850102-14-5679');
INSERT INTO manual_financial_inputs (
    client_nric, casa_balance, fixed_deposit_amount, investment_portfolio_value, 
    insurance_value, other_assets_value, loan_outstanding_balance, credit_card_limit, 
    credit_card_used_amount, overdraft_limit, overdraft_used_amount, monthly_inflow, 
    monthly_outflow, three_month_expenses, current_emergency_fund, product_holdings
) VALUES 
    ...
    ('850102-14-5679', 30000, 150000, 200000, 100000, 320000, 155000, 15000, 6000, 8000, 0, 35000, 25000, 75000, 30000,
     '[{"name": "Basic Savings", "type": "savings", "value": 30000, "count": 1}, {"name": "Fixed Deposit", "type": "investment", "value": 150000, "count": 1}, {"name": "Investment Fund", "type": "investment", "value": 200000, "count": 1}, {"name": "Life Insurance", "type": "insurance", "value": 100000, "count": 1}]');

-- 6. Clear existing data and insert calculated financial data
DELETE FROM calculated_financial_data WHERE client_nric IN ('850102-14-5678', '850102-14-5679');
INSERT INTO calculated_financial_data (
    client_nric, total_assets, total_liabilities, net_position, total_portfolio_value,
    monthly_net_cash_flow, average_monthly_casa, casa_peak_month, casa_peak_value,
    utilization_rate, asset_utilization_rate, emergency_fund_ratio, average_transaction_amount,
    profitability_score, calculated_birthday, calculated_age
) VALUES 
    ('850102-14-5678', 1200000, 310000, 890000, 500000, 15000, 50000, 'Dec', 50000, 40.0, 80.0, 47.6, 2500, 85.0, '1985-01-02', 38),
    ('850102-14-5679', 800000, 250000, 550000, 350000, 10000, 30000, 'Dec', 30000, 40.0, 75.0, 40.0, 2000, 65.0, '1985-01-02', 38);

-- 7. Clear existing data and insert transaction behavioral data
DELETE FROM transaction_behavioral_data WHERE client_nric IN ('850102-14-5678', '850102-14-5679');
INSERT INTO transaction_behavioral_data (
    client_nric, categorized_spending, fund_transfers_volume, fund_transfers_count,
    pos_purchases_volume, pos_purchases_count, atm_withdrawals_volume, atm_withdrawals_count,
    fx_transactions_volume, fx_transactions_count, unusual_transactions, total_transaction_volume,
    total_transaction_count, average_transaction_size
) VALUES 
    ('850102-14-5678', 
...
-- 8. Clear existing data and insert financial trends monthly data
DELETE FROM financial_trends_monthly WHERE client_nric IN ('850102-14-5678', '850102-14-5679');
INSERT INTO financial_trends_monthly (
    client_nric, month_year, casa_balance, total_assets, total_liabilities, net_worth, credit_utilization, investment_value
) VALUES 
    ...
    ('850102-14-5679', '2024-01', 28000, 780000, 250000, 530000, 40.0, 200000),
    ('850102-14-5679', '2024-02', 29000, 785000, 250000, 535000, 40.0, 200000),
    ('850102-14-5679', '2024-03', 30000, 790000, 250000, 540000, 40.0, 200000),
    ('850102-14-5679', '2024-04', 30000, 800000, 250000, 550000, 40.0, 200000);
